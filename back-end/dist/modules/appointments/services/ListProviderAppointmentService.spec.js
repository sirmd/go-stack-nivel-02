...
var ListProviderAppointmentService_1 = __importDefault(require("./ListProviderAppointmentService"));
describe('ListProviderAvailability', function () {
    var listProviderAppointmentService;
    ...
    beforeEach(function () {
        ...
        listProviderAppointmentService = new ListProviderAppointmentService_1.default(fakeAppointmentsRepository, fakeCacheProvider);
    });
    it('should be able to list the appointments on a specific date', function () { return __awaiter(void 0, void 0, void 0, function () {
