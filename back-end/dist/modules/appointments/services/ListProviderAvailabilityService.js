...
var ListProviderAvailabilityService = /** @class */ (function () {
    function ListProviderAvailabilityService(appointmentsRepository) {
        this.appointmentsRepository = appointmentsRepository;
    }
    ListProviderAvailabilityService.prototype.execute = function (_a) {
    ...
    ListProviderAvailabilityService = __decorate([
        tsyringe_1.injectable(),
        __param(0, tsyringe_1.inject('AppointmentsRepository')),
        __metadata("design:paramtypes", [Object])
    ], ListProviderAvailabilityService);
    return ListProviderAvailabilityService;
}());
exports.default = ListProviderAvailabilityService;
