...
describe('UpdateProfile', function () {
    ...
    it('should be able to update the profile', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    updatedUser = _a.sent();
                    return [4 /*yield*/, expect(updatedUser.name).toBe('John Doe')];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, expect(updatedUser.email).toBe('johndoe@example.com')];
                case 4:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should not be able to update the email to an existing email', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUsersRepository.create({
    ...
    it('should be able to update the password', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    updatedUser = _a.sent();
                    return [4 /*yield*/, expect(updatedUser.password).toBe('123123')];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should not be able to update the password without the old password', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUsersRepository.create({
    ...
    it('should not be able to update the password with the wrong old password', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUsersRepository.create({
    ...
    it('should not be able to show the profile for non-existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
