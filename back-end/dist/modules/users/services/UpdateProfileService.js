                ...
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        if (userWithUpdatedEmail && user.id !== userWithUpdatedEmail.id) {
                            throw new AppError_1.default('Email is already being used');
                        }
                        if (password && !old_password) {
                            throw new AppError_1.default('You need to inform the old password to change the password');
                        }
                    ...
                    case 3:
                        ...
                        if (!checkOldPassword) {
                            throw new AppError_1.default('The old password informed is incorrect.');
                        }
                        _b = user;
