...
var ResetPasswordService = /** @class */ (function () {
    ...
    ResetPasswordService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var userToken, tokenCreation, compareDate, user, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        tokenCreation = userToken.created_at;
                        compareDate = date_fns_1.addHours(tokenCreation, 2);
                        if (date_fns_1.isAfter(new Date(Date.now()), compareDate)) {
