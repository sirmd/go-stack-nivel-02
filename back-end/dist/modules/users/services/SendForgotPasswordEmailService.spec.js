...
var sendForgotEmail;
describe('SendForgotEmail', function () {
    ...
    beforeEach(function () {
        ...
        sendForgotEmail = new SendForgotPasswordEmailService_1.default(fakeUsersRepository, fakeMailProvider, fakeUserTokensRepository);
    });
    it('should be able to recover the password using the email', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, sendForgotEmail.execute({
                            email: 'johndoe@example.com',
                        })];
                case 2:
                    _a.sent();
    ...
    it('should not be able to recover password for a non-existing email', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(sendForgotEmail.execute({
                        email: 'johndoe@example.com',
    ...
    it('should generate forgot password token', function () { return __awaiter(void 0, void 0, void 0, function () {
