...
describe('ResetPassword', function () {
    ...
    it('should be able to reset the password', function () { return __awaiter(void 0, void 0, void 0, function () {
        var id, token, generateHash, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    id = (_a.sent()).id;
                    return [4 /*yield*/, fakeUserTokensRepository.generate(id)];
                case 2:
                    token = (_a.sent()).token;
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, fakeUsersRepository.findById(id)];
                case 4:
                    user = _a.sent();
                    expect(generateHash).toHaveBeenCalledWith('123123');
                    expect(user === null || user === void 0 ? void 0 : user.password).toBe('123123');
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    it('should not be able to reset the password with non-existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUserTokensRepository.generate('ops')];
                case 1:
                    token = (_a.sent()).token;
    ...
    it('should not be able to reset password if token generated 2h earlier', function () { return __awaiter(void 0, void 0, void 0, function () {
        var id, token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUsersRepository.create({
